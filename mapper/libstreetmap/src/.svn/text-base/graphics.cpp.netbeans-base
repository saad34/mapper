...
void set_world(const t_bound_box& bounds) {
    /* Sets the coordinate system the user wants to draw into.          */
...
bool t_point::operator==(const t_point& right) {
...
bool t_bound_box::operator==(const t_bound_box& right) {
    if((this->bottom_left() == right.bottom_left()) && 
       (this->top_right() == right.top_right())) return true;
    else return false;
}
