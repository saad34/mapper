...
//        TEST_FIXTURE(Map_Fixture, intersection_map_functionality) {
//               CHECK_EQUAL(1648, get_intersections_map().find("Yonge Street & Eglinton Avenue East & Eglinton Avenue West")->second);
//		CHECK_EQUAL(23162, get_intersections_map().find("Bay Street & Dundas Street West")->second);
//		CHECK_EQUAL(58114, get_intersections_map().find("Bay Street & Wellington Street West")->second);
//		CHECK_EQUAL(2298, get_intersections_map().find("Yonge Street & Dundas Street West & Dundas Street East")->second);
//		CHECK_EQUAL(3023, get_intersections_map().find("Yonge Street & College Street & Carlton Street")->second);
//		CHECK_EQUAL(2522, get_intersections_map().find("Yonge Street & Queen Street West & Queen Street East")->second);
//		CHECK_EQUAL(40201, get_intersections_map().find("Bay Street & Adelaide Street West")->second);
//		CHECK_EQUAL(10538, get_intersections_map().find("Yonge Street & King Street West & King Street East")->second);
//		CHECK_EQUAL(1896, get_intersections_map().find("Yonge Street & Bloor Street East & Bloor Street West")->second);
//		CHECK_EQUAL(27814, get_intersections_map().find("Bloor Street West & Bay Street")->second);
//		CHECK_EQUAL(659, get_intersections_map().find("Yonge Street & Saint Clair Avenue East & Saint Clair Avenue West")->second);
//		CHECK_EQUAL(9555, get_intersections_map().find("University Avenue & Front Street West & York Street")->second);
//		CHECK_EQUAL(2972, get_intersections_map().find("Yonge Street & Adelaide Street West & Adelaide Street East")->second);
//		CHECK_EQUAL(3482, get_intersections_map().find("Yonge Street & Gerrard Street West & Gerrard Street East")->second);
//		CHECK_EQUAL(1851, get_intersections_map().find("Bloor Street East & Church Street")->second);
//		CHECK_EQUAL(58107, get_intersections_map().find("King Street West & Bay Street")->second);
//		CHECK_EQUAL(5438, get_intersections_map().find("University Avenue & Dundas Street West")->second);
//		CHECK_EQUAL(1376, get_intersections_map().find("St. George Street & Harbord Street & Hoskin Avenue")->second);
//		CHECK_EQUAL(5720, get_intersections_map().find("College Street & Bay Street")->second);
//		CHECK_EQUAL(5600, get_intersections_map().find("Queen Street West & John Street")->second);
//		CHECK_EQUAL(3369, get_intersections_map().find("Yonge Street & Wellesley Street East & Wellesley Street West")->second);
//		CHECK_EQUAL(63371, get_intersections_map().find("Queen Street West & Bay Street")->second);
//		CHECK_EQUAL(130357, get_intersections_map().find("Avenue Road & Bloor Street West & Queen's Park")->second);
//		CHECK_EQUAL(5450, get_intersections_map().find("Front Street West & John Street & Convention centre loading dock")->second);
//		CHECK_EQUAL(73004, get_intersections_map().find("University Avenue & Wellington Street West")->second);
//        }
//        TEST_FIXTURE(Map_Fixture, street_map_functionality) {
//		CHECK_EQUAL(38, get_streets_map().find("Yonge Street")->second);
//		CHECK_EQUAL(180, get_streets_map().find("Eglinton Avenue East")->second);
//		CHECK_EQUAL(233, get_streets_map().find("Bay Street")->second);
//		CHECK_EQUAL(281, get_streets_map().find("Dundas Street West")->second);
//		CHECK_EQUAL(196, get_streets_map().find("College Street")->second);
//		CHECK_EQUAL(138, get_streets_map().find("University Avenue")->second);
//		CHECK_EQUAL(133, get_streets_map().find("Bloor Street West")->second);
//		CHECK_EQUAL(132, get_streets_map().find("Danforth Avenue")->second);
//		CHECK_EQUAL(194, get_streets_map().find("Queen Street West")->second);
//		CHECK_EQUAL(390, get_streets_map().find("Queen Street East")->second);
//		CHECK_EQUAL(13, get_streets_map().find("Avenue Road")->second);
//		CHECK_EQUAL(145, get_streets_map().find("Bathurst Street")->second);
//		CHECK_EQUAL(161, get_streets_map().find("Dufferin Street")->second);
//		CHECK_EQUAL(4018, get_streets_map().find("Weston Road")->second);
//		CHECK_EQUAL(69, get_streets_map().find("Sheppard Avenue East")->second);
//		CHECK_EQUAL(202, get_streets_map().find("Finch Avenue West")->second);
//		CHECK_EQUAL(185, get_streets_map().find("Steeles Avenue East")->second);
//		CHECK_EQUAL(433, get_streets_map().find("William R. Allen Road")->second);
//		CHECK_EQUAL(142, get_streets_map().find("Lake Shore Boulevard West")->second);
//		CHECK_EQUAL(4396, get_streets_map().find("Erin Mills Parkway")->second);
//		CHECK_EQUAL(2362, get_streets_map().find("Morningside Avenue")->second);
//		CHECK_EQUAL(683, get_streets_map().find("McCowan Road")->second);
//	}
